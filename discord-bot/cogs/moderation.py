...
class Moderation(commands.Cog, name="moderation"):
    ...
    async def ban(self, ctx: commands.Context, member: discord.Member, *, reason: str = "No reason provided"):
        if member.top_role >= ctx.author.top_role and ctx.author.id != ctx.guild.owner_id:
            await ctx.send(embed=error_embed("You can't ban someone with an equal or higher role."))
            return
    ...
    async def unban(self, ctx: commands.Context, user_id: int, *, reason: str = "No reason provided"):
        try:
            ...
            await ctx.send(embed=error_embed("That user isn't banned or doesn't exist."))
            return
    ...
    async def kick(self, ctx: commands.Context, member: discord.Member, *, reason: str = "No reason provided"):
        if member.top_role >= ctx.author.top_role and ctx.author.id != ctx.guild.owner_id:
            await ctx.send(embed=error_embed("You can't kick someone with an equal or higher role."))
            return
    ...
    async def removetimeout(self, ctx: commands.Context, member: discord.Member, *, reason: str = "No reason provided"):
        ...
        embed = mod_embed("Timeout Removed", f"**{member}**'s timeout was removed.")
        await ctx.send(embed=embed)
        await self._log(ctx, embed)
    ...
    async def unwarn(self, ctx: commands.Context, warning_id: int):
        ...
        await conn.commit()
        if cur.rowcount == 0:
            await ctx.send(embed=error_embed("No warning found with that ID."))
            return
        await ctx.send(embed=success_embed(f"Warning `#{warning_id}` removed."))
    ...
    async def warnings(self, ctx: commands.Context, member: discord.Member):
        ...
        if not rows:
            await ctx.send(embed=mod_embed("Warnings", f"**{member}** has no warnings."))
            return
    ...
    async def nuke(self, ctx: commands.Context):
        ...
        embed = mod_embed("Channel Nuked", "This channel has been nuked.")
    ...
    async def lock(self, ctx: commands.Context):
        ...
        await ctx.send(embed=mod_embed("Channel Locked", f"🔒 {ctx.channel.mention} has been locked."))
    ...
    async def unlock(self, ctx: commands.Context):
        ...
        await ctx.channel.set_permissions(ctx.guild.default_role, overwrite=overwrite)
        await ctx.send(embed=mod_embed("Channel Unlocked", f"🔓 {ctx.channel.mention} has been unlocked."))
    ...
    async def lockdown(self, ctx: commands.Context):
        ...
        for channel in ctx.guild.text_channels:
            ...
            try:
                ...
                continue
        await ctx.send(embed=mod_embed("Server Lockdown", f"🔒 Locked **{count}** channels."))
    ...
    async def unlockdown(self, ctx: commands.Context):
        ...
        for channel in ctx.guild.text_channels:
            ...
            try:
                ...
                continue
        await ctx.send(embed=mod_embed("Lockdown Lifted", f"🔓 Unlocked **{count}** channels."))
    ...
    async def hide(self, ctx: commands.Context):
        ...
        await ctx.channel.set_permissions(ctx.guild.default_role, overwrite=overwrite)
        await ctx.send(embed=mod_embed("Channel Hidden", f"👻 {ctx.channel.mention} is now hidden."))
    ...
    async def unhide(self, ctx: commands.Context):
        ...
        await ctx.channel.set_permissions(ctx.guild.default_role, overwrite=overwrite)
        await ctx.send(embed=mod_embed("Channel Unhidden", f"👁️ {ctx.channel.mention} is visible again."))
    ...
    async def nickname(self, ctx: commands.Context, member: discord.Member, *, name: str | None = None):
        ...
        if name:
            await ctx.send(embed=success_embed(f"**{member}**'s nickname changed to **{name}**."))
        else:
            await ctx.send(embed=success_embed(f"**{member}**'s nickname reset."))
    ...
    async def role(self, ctx: commands.Context, member: discord.Member, *, role: discord.Role):
        if role in member.roles:
            ...
            await ctx.send(embed=success_embed(f"Removed **{role.name}** from **{member}**."))
        else:
            await member.add_roles(role, reason=f"By {ctx.author}")
            await ctx.send(embed=success_embed(f"Added **{role.name}** to **{member}**."))
    ...
    async def voicekick(self, ctx: commands.Context, member: discord.Member):
        if not member.voice:
            await ctx.send(embed=error_embed(f"**{member}** isn't in a voice channel."))
            return
        await member.move_to(None, reason=f"Voicekicked by {ctx.author}")
        await ctx.send(embed=success_embed(f"**{member}** was disconnected from voice."))
    ...
    async def move(self, ctx: commands.Context, member: discord.Member, *, channel: discord.VoiceChannel):
        ...
        await ctx.send(embed=success_embed(f"Moved **{member}** to **{channel.name}**."))
    ...
    async def deafen(self, ctx: commands.Context, member: discord.Member):
        ...
        await ctx.send(embed=success_embed(f"**{member}** has been server-deafened."))
    ...
    async def undeafen(self, ctx: commands.Context, member: discord.Member):
        ...
        await ctx.send(embed=success_embed(f"**{member}**'s server-deafen removed."))
